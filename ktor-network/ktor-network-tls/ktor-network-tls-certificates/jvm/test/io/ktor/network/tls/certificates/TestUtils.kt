...
internal fun assertExtensionsForServerKeyType(
    ...
    assertEquals(listOf(OID.ServerAuth.identifier), cert.extendedKeyUsage, "server auth should be added for Server key type")
...
internal fun assertExtensionsForClientKeyType(cert: X509Certificate) {
    ...
    assertEquals(
        listOf(OID.ClientAuth.identifier),
        cert.extendedKeyUsage,
        "client auth should be added for Client key type"
    )
