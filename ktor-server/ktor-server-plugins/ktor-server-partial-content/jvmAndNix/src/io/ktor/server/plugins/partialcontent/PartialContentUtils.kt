...
internal suspend fun BodyTransformedHook.Context.processRange(
    ...
    if (merged.isEmpty()) {
        LOGGER.trace("Responding 416 RequestedRangeNotSatisfiable: range is empty")
...
internal fun BodyTransformedHook.Context.processSingleRange(
    ...
    LOGGER.trace("Responding 206 PartialContent: single range $range")
...
internal suspend fun BodyTransformedHook.Context.processMultiRange(
    ...
    LOGGER.trace("Responding 206 PartialContent: multiple range ${ranges.joinToString(",")}")
